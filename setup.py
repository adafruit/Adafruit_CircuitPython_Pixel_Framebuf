...
setup(
    ...
    keywords="adafruit blinka circuitpython micropython pixel_framebuf neopixel framebuf "
    "framebuffer dotstar matrix animation led ws2812 ap102",
    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    # TODO: IF LIBRARY FILES ARE A PACKAGE FOLDER,
    #       CHANGE `py_modules=['...']` TO `packages=['...']`
    py_modules=["adafruit_pixel_framebuf"],
)
